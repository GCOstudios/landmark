                ...
                if ($attachments) {
                    ...
                    if ($attachments) {
                        foreach ($attachments as $attachment) {
                            ...
                            $img = virtue_get_image_array($fimg['width'], $fimg['height'], true, null, $alt, $attachment, false);
            ...
            ?>
           	...
           	<?php } else if($postsummery == 'videolight') {
					if (has_post_thumbnail( $post->ID ) ) {
						...
						$img = virtue_get_image_array($kt_portfolio_loop['slidewidth'], $kt_portfolio_loop['slideheight'], true, null, null, $image_id, false);
                        ...
                        ?>
							<div class="imghoverclass">
	                            <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" class="kt-intrinsic" style="padding-bottom:<?php echo ($img[ 'height' ]/$img[ 'width' ]) * 100;?>%;">
	                                <img <?php echo $image_src_output; ?> alt="<?php echo esc_attr( $img[ 'alt' ] ); ?>" width="<?php echo esc_attr( $img[ 'width' ] );?>" height="<?php echo esc_attr( $img[ 'height' ] );?>" <?php echo $img[ 'srcset' ];?> class="lightboxhover" style="display: block;">
	                            </a> 
	                        </div>
