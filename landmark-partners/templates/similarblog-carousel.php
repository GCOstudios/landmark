    ...
    <div class="blog-carouselcase fredcarousel">
		...
		<div id="carouselcontainer-blog" class="rowtight fadein-carousel">
 		...
 		<div class="clearfix"></div>
            <a id="prevport-blog" class="prev_carousel icon-arrow-left" href="#" aria-label="<?php echo __('Navigate left', 'virtue');?>"></a>
			<a id="nextport-blog" class="next_carousel icon-arrow-right" href="#" aria-label="<?php echo __('Navigate right', 'virtue');?>"></a>
        </div>
    </div>
