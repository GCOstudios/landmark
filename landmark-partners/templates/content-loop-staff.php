	...
	<div class="<?php echo esc_attr( $itemsize );?> <?php echo esc_attr( strtolower( $tax ) ); ?> s_item">
		<div class="grid_item staff_item kt_item_fade_in kad_staff_fade_in postclass">
			<?php if ( has_post_thumbnail( $post->ID ) ) {
				$img = virtue_get_image_array( $image_width , $image_height, $crop, null, null, get_post_thumbnail_id() );?>
				<div class="imghoverclass staff-item-img">
				...
				<?php }?>
						<img src="<?php echo esc_url( $img[ 'src' ] ); ?>" width="<?php echo esc_attr( $img[ 'width' ] ); ?>" height="<?php echo esc_attr( $img[ 'height' ] ); ?>" alt="<?php echo esc_attr( $img[ 'alt' ] ); ?>" <?php echo wp_kses_post( $img[ 'srcset' ] );?> style="display: block;">
