...
<?php 
	...
	if (has_post_thumbnail( $post->ID ) ) {
		...
		<div class="imghoverclass postfeat post-single-img" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
			<a href="<?php echo esc_url( $img['full'] ); ?>" rel-data="lightbox" class="">
			<img <?php echo $image_src_output; ?> itemprop="contentUrl" alt="<?php the_title(); ?>" width="<?php echo esc_attr( $img['width'] );?>" height="<?php echo esc_attr( $img['height'] );?>" <?php echo $img['srcset']; ?> />
