<?php
/*
Template Name: Sectors Grid Template
*/
...
<?php do_action('kadence_page_title_container'); ?>



<section id="sectors-page">
	<div id="sectors" class="container">
        <div class="row">
            ...
            <?php if ( ! post_password_required() ) { 
                ...
                $sectors_category = get_post_meta( $post->ID, '_kad_sectors_type', true );
                $portfolio_items = get_post_meta( $post->ID, '_kad_sectors_items', true );
                $portfolio_order = get_post_meta( $post->ID, '_kad_sectors_order', true );
                $portfolio_filter = get_post_meta( $post->ID, '_kad_sectors_filter', true );
                $portfolio_column = get_post_meta( $post->ID, '_kad_sectors_columns', true );
                $portfolio_item_excerpt = get_post_meta( $post->ID, '_kad_sectors_item_excerpt', true );
                $portfolio_item_types = get_post_meta( $post->ID, '_kad_sectors_item_types', true );
                $portfolio_cropheight = get_post_meta( $post->ID, '_kad_sectors_img_crop', true );
                $portfolio_crop = get_post_meta( $post->ID, '_kad_sectors_crop', true );
                $portfolio_style = get_post_meta( $post->ID, '_kad_sectors_style', true );
                $portfolio_lightbox = get_post_meta( $post->ID, '_kad_sectors_lightbox', true );
                  ...
                  $wp_query->query(array(
                    ...
                    if($portfolio_style == 'mosaic'){
                            ...
                            <?php do_action('kadence_portfolio_loop_start');
                                    get_template_part('templates/content', 'loop-sectors'); 
                                  do_action('kadence_portfolio_loop_end');
                            ?>
                            </div>
                    <?php } ?>
